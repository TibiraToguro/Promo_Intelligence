...
const api = (() => {
  ...
  return {
    ...
    getSlotsRange(de, ate)          { return _get('GET_SLOTS_RANGE', { de, ate }); },
    ...
    excluirSlot(slotId)             { return _post('EXCLUIR_SLOT', { slot_id: slotId }); },
    excluirSlotsLote(ids)           { return _post('EXCLUIR_SLOTS_LOTE', { ids }); },
    getLocaisFrequentes()           { return _get('GET_LOCAIS_FREQUENTES'); },
    salvarLocalFrequente(dados)      { return _post('SALVAR_LOCAL_FREQUENTE', dados); },
